...
internal sealed class AggregationBuildableExpression(Expression<Func<WinEvent, bool>> predicate, Expression<Func<WinEvent?>> aggregate, ISet<string> aggregationProperties) : BuildableExpression
{
