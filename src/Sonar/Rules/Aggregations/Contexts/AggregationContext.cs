...
namespace Sonar.Rules.Aggregations.Contexts;

internal sealed class AggregationContext(ILogger logger, IHostApplicationLifetime hostApplicationLifetime, string ruleId)
    : ContextBase(logger, hostApplicationLifetime, Path.Join(AppContext.BaseDirectory, "Aggregations"), $"{ruleId}.db")
{
