...
internal static class SqlConnectionExtensions
{
    ...
    {
        public async Task<ISet<string>> CreateColumnsAsync(ILogger logger, ISet<string> columns, CancellationToken cancellationToken)
        {
            try
            {
        ...
        public async Task CreateIndexAsync(ILogger logger, ISet<string> indexes, CancellationToken cancellationToken)
        {
            try
            {
